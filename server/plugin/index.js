...
export const pluginEvents = {
   ...
   * @returns {Promise<{title: string; description: string; numberOfLessons: number; tags: string[]; dashedName: string; isIntegrated: boolean; isPublic: boolean; runTestsOnWatch: boolean; seedEveryLesson: boolean; isResetEnabled: boolean; blockingTests: boolean; breakOnFailure: boolean; }>}
   */
